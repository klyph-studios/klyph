...
export function AiSolutions() {
  ...
  return (
    <section id="ai" className="section sec-dark py-32 bg-black text-white border-t border-b border-white/10 relative overflow-hidden">
      <div className="container mx-auto px-8 max-w-[1240px]">
        ...
        <div className="ai-grid grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="ai-inner glass-dark rounded-2xl p-10 relative overflow-hidden transition-all duration-400 hover:-translate-y-2 hover:border-white/30">
            <div className="ai-glow absolute top-0 right-0 w-52 h-52 rounded-full bg-white/10 blur-[70px] pointer-events-none" />
            <div className="ai-tag text-xs font-bold font-syne tracking-widest text-zinc-400 uppercase mb-4">Workflow Systems</div>
            <h3 className="ai-ttl font-syne font-extrabold text-2xl mb-4 text-white">Autonomous Workflows</h3>
            <p className="ai-desc text-zinc-400 text-sm leading-relaxed mb-8">
            ...
            <div className="ai-feats flex flex-wrap gap-2.5">
              {["Client Reservation Automation", "Lead Qualification", "Email & SMS Workflows", "Data Sync", "Automated Insights", "Python / Java API Ready"].map((f, j) => (
                <span className="ai-feat text-xs px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-white" key={j}>
                  {f}
                </span>
              ))}
            </div>
          ...
          <div className="ai-inner glass-dark rounded-2xl p-10 relative overflow-hidden transition-all duration-400 hover:-translate-y-2 hover:border-white/30">
            <div className="ai-glow absolute top-0 right-0 w-52 h-52 rounded-full bg-white/10 blur-[70px] pointer-events-none" />
            <div className="ai-tag text-xs font-bold font-syne tracking-widest text-zinc-400 uppercase mb-4">AI Agents</div>
            <h3 className="ai-ttl font-syne font-extrabold text-2xl mb-4 text-white">Autonomous Voice & Chat Agents</h3>
            <p className="ai-desc text-zinc-400 text-sm leading-relaxed mb-8">
